...
__C.DATASETS.SHAPENET.TAXONOMY_FILE_PATH    = '/content/Pix2Vox/datasets/PascalShapeNet.json'
# __C.DATASETS.SHAPENET.TAXONOMY_FILE_PATH  = './datasets/PascalShapeNet.json'
__C.DATASETS.SHAPENET.RENDERING_PATH        = '/content/drive/MyDrive/Datasets/ShapeNet/ShapeNetRendering/%s/%s/rendering/%02d.png'
# __C.DATASETS.SHAPENET.RENDERING_PATH      = '/home/hzxie/Datasets/ShapeNet/PascalShapeNetRendering/%s/%s/render_%04d.jpg'
__C.DATASETS.SHAPENET.VOXEL_PATH            = '/content/drive/MyDrive/Datasets/ShapeNet/ShapeNetVox32/%s/%s/model.binvox'
...
#
__C.DIR                                     = edict()
__C.DIR.OUT_PATH                            = '/content/drive/MyDrive/Output'
__C.DIR.RANDOM_BG_PATH                      = '/content/drive/MyDrive/Datasets/Images/JPEGImages'
